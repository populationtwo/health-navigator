...
function navigator_setup() {
	 ...
	 * If you're building a theme based on navigator, use a find and replace
	 * to change 'navigator' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'navigator', get_template_directory() . '/languages' );
...
function navigator_scripts() {
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/css/min/style.css' );
	wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/assets/css/min/style.css' );
